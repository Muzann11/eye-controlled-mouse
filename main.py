    ...
    if landmark_points:
        ...
        for landmark in left:
            ...
            if (left[0].y - left[1].y) < 0.004:
                if not eye_closed:  # Hanya klik jika sebelumnya mata tidak tertutup
                    pyautogui.click()
                    eye_closed = True  # Set flag bahwa mata sedang tertutup
            else:
                eye_closed = False  # Reset flag jika mata terbuka kembali
